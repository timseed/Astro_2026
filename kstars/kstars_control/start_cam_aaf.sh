...
#echo "start indi_simulator_gps -n \"gps\" " >>$PIPE
#echo "Started gps_simulator process."
echo "start indi_simulator_telescope -n mount" >>$PIPE
echo "Start Simulator Mount driver"
#echo "start indi_staradventurer2i_telescope -n \"mount\"" >> $PIPE
echo "Starting AAF"
echo "start indi_toupcam_focuser -n aaf " >>$PIPE
sleep 2
#echo "Starting Guide Scope"
#echo "start indi_v4l2_ccd -n \"guide\" " >> $PIPE
#sleep 2
echo "Completed"
echo "================="
echo "= Indi Status   ="
